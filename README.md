...
**3.** **Access the API** 
  ...
  - Once the container is running, the API is accessible at:
    ...
    - **Semantic‑cache warmup endpoint:** `api/v1/cache/warmup`  
